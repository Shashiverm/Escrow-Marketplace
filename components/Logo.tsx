      ...
      >
        ...
        >
          ...
          <path
            ...
            fill="url(#stellar-escrow-grad-root)"
            fillOpacity="0.2"
            stroke="url(#stellar-escrow-grad-root)"
            strokeWidth="4"
          ...
          <circle
            ...
            cy="50"
            r="24"
            stroke="url(#stellar-stroke-grad-root)"
            strokeWidth="3"
            strokeDasharray="6 3"
          />
          <path
